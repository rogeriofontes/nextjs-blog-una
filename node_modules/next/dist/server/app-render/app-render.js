   ...
   */ const generateStaticHTML = supportsDynamicHTML !== true;
     ...
     */ const createComponentTree = async ({ createSegmentPath , loaderTree: tree , parentParams , firstItem , rootLayoutIncluded , injectedCSS , injectedFontPreloadTags , asNotFound  })=>{
       ...
       */ const walkTreeWithFlightRouterState = async ({ createSegmentPath , loaderTreeToFilter , parentParams , isFirst , flightRouterState , parentRendered , rscPayloadHead , injectedCSS , injectedFontPreloadTags , rootLayoutIncluded , asNotFound  })=>{
                ...
                const parallelRoutesKeys = Object.keys(parallelRoutes).sort((parallelRouteKeyA, parallelRouteKeyB)=>{
                    if ((flightRouterState == null ? void 0 : flightRouterState[1][parallelRouteKeyA][3]) === "refetch") {
                        return -1;
                    }
                    if ((flightRouterState == null ? void 0 : flightRouterState[1][parallelRouteKeyB][3]) === "refetch") {
                        return 1;
                    }
                    return 0;
                });
         ...
         */ const renderComponentsOnThisLevel = // No further router state available
                ...
                flightRouterState[3] === "refetch" || // if any of the parallel routes segments differ or have a refresh marker
                Object.entries(parallelRoutes).some(([parallelRouteKey, [parallelRouteSegment]])=>{
                    const [incomingParallelRouteSegment] = flightRouterState[1][parallelRouteKey] ?? [];
                    return incomingParallelRouteSegment === "__DEFAULT__" && parallelRouteSegment !== "__DEFAULT__";
                });
                ...
                for (const parallelRouteKey1 of parallelRoutesKeys){
                    const parallelRoute = parallelRoutes[parallelRouteKey1];
                    ...
                    const path = await walkTreeWithFlightRouterState({
                        ...
                        parentParams: currentParams,
                        flightRouterState: flightRouterState && flightRouterState[1][parallelRouteKey1],
